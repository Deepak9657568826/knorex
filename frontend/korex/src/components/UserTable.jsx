...
const UserTable = () => {
    ...
    useEffect(() => {
        axios.get('https://knorex-1.onrender.com/api/users')
    ...
    const handleDeleteUser = (userId) => {
        axios.delete(`https://knorex-1.onrender.com/api/users/${userId}`)
            .then(() => {
    ...
    return (
        <div>
            ...
            <button onClick={() => axios.post('https://knorex-1.onrender.com/api/users/export', { ids: selectedUsers }, { responseType: 'blob' })
                .then(response => {
